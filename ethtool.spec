...
Version  : 6.14
Release  : 60
URL      : https://www.kernel.org/pub/software/network/ethtool/ethtool-6.14.tar.gz
Source0  : https://www.kernel.org/pub/software/network/ethtool/ethtool-6.14.tar.gz
...
%prep
%setup -q -n ethtool-6.14
cd %{_builddir}/ethtool-6.14
pushd ..
cp -a ethtool-6.14 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744124493
