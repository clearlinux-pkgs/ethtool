...
Source0  : https://www.kernel.org/pub/software/network/ethtool/ethtool-5.4.tar.xz
...
%prep
%setup -q -n ethtool-5.4
cd %{_builddir}/ethtool-5.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578694468
...
cp %{_builddir}/ethtool-5.4/COPYING %{buildroot}/usr/share/package-licenses/ethtool/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/ethtool-5.4/LICENSE %{buildroot}/usr/share/package-licenses/ethtool/d25eb6311e5d0398a98818545298bc0fa10efab1
%make_install
