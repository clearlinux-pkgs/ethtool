...
Version  : 6.7
Release  : 56
URL      : https://www.kernel.org/pub/software/network/ethtool/ethtool-6.7.tar.xz
Source0  : https://www.kernel.org/pub/software/network/ethtool/ethtool-6.7.tar.xz
...
%prep
%setup -q -n ethtool-6.7
cd %{_builddir}/ethtool-6.7
pushd ..
cp -a ethtool-6.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706541668
