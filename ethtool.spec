...
Version  : 6.0
Release  : 47
URL      : https://www.kernel.org/pub/software/network/ethtool/ethtool-6.0.tar.xz
Source0  : https://www.kernel.org/pub/software/network/ethtool/ethtool-6.0.tar.xz
...
%prep
%setup -q -n ethtool-6.0
cd %{_builddir}/ethtool-6.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665443808
