...
Version  : 6.2
Release  : 49
URL      : https://www.kernel.org/pub/software/network/ethtool/ethtool-6.2.tar.xz
Source0  : https://www.kernel.org/pub/software/network/ethtool/ethtool-6.2.tar.xz
...
%prep
%setup -q -n ethtool-6.2
cd %{_builddir}/ethtool-6.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677004295
