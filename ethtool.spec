...
Version  : 6.10
Release  : 58
URL      : https://www.kernel.org/pub/software/network/ethtool/ethtool-6.10.tar.gz
Source0  : https://www.kernel.org/pub/software/network/ethtool/ethtool-6.10.tar.gz
...
%prep
%setup -q -n ethtool-6.10
cd %{_builddir}/ethtool-6.10
pushd ..
cp -a ethtool-6.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723479647
