...
Source0  : https://www.kernel.org/pub/software/network/ethtool/ethtool-6.1.tar.xz
...
%prep
%setup -q -n ethtool-6.1
cd %{_builddir}/ethtool-6.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671496952
