...
Version  : 6.11
Release  : 59
URL      : https://www.kernel.org/pub/software/network/ethtool/ethtool-6.11.tar.gz
Source0  : https://www.kernel.org/pub/software/network/ethtool/ethtool-6.11.tar.gz
...
%prep
%setup -q -n ethtool-6.11
cd %{_builddir}/ethtool-6.11
pushd ..
cp -a ethtool-6.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728485054
