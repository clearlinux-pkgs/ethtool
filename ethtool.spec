...
Version  : 5.19
Release  : 46
URL      : https://www.kernel.org/pub/software/network/ethtool/ethtool-5.19.tar.xz
Source0  : https://www.kernel.org/pub/software/network/ethtool/ethtool-5.19.tar.xz
...
%prep
%setup -q -n ethtool-5.19
cd %{_builddir}/ethtool-5.19
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661190038
