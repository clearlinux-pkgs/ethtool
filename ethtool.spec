...
Source0  : https://www.kernel.org/pub/software/network/ethtool/ethtool-6.6.tar.xz
...
%prep
%setup -q -n ethtool-6.6
cd %{_builddir}/ethtool-6.6
pushd ..
cp -a ethtool-6.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701953900
